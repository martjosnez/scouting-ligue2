...
.page-title { font-family: 'Bebas Neue', sans-serif; font-size: 52px; letter-spacing: 3px; color: #F0F2F5; line-height: 1; margin-bottom: 4px; }
...
.section-title { font-size: 10px; text-transform: uppercase; letter-spacing: 2px; color: #6B7280; margin: 8px 0 16px; padding-bottom: 8px; border-bottom: 1px solid rgba(255,255,255,0.07); }
.short-item { background: #141720; border: 1px solid rgba(255,255,255,0.07); border-radius: 10px; padding: 14px 18px; display: flex; align-items: center; gap: 14px; margin-bottom: 8px; }
...
.status-badge { font-size: 11px; padding: 3px 10px; border-radius: 20px; border: 1px solid; }
...
div[data-testid="stButton"] button { background: #E8281A !important; color: white !important; border: none !important; border-radius: 8px !important; }
</style>
...
if shortlist.empty:
    st.markdown('<div style="background:#141720;border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:20px;text-align:center;color:#6B7280;font-size:13px;">Shortlist vide</div>', unsafe_allow_html=True)
else:
    for _, row in shortlist.iterrows():
        ...
        if note_txt:
            html += '<div style="font-size:12px;color:#6B7280;font-style:italic;flex:1">' + note_txt + '</div>'
